...
for (let hr of allHrs) {
  if (hr.getAttribute("class") === "image") {
...
imgElm.src =
  "https://images.unsplash.com/photo-1647478577669-172e8145212d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwyfHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60";
